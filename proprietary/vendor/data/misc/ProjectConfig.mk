...
CUSTOM_HAL_IMGSENSOR = s5k3p3sx_mipi_raw imx135_mipi_raw imx214_mipi_raw imx363_mipi_raw ov8856_mipi_raw s5k3p9sp_mipi_raw gc0310_mipi_yuv
CUSTOM_HAL_LENS = dw9714af dw9800af dw9763af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9763af
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3p3sx_mipi_raw imx135_mipi_raw imx214_mipi_raw imx363_mipi_raw gc0310_mipi_yuv
CUSTOM_HAL_MAIN_LENS = dw9714af dw9800af dw9763af
CUSTOM_HAL_MSENSORLIB =akl
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = ad5820af
CUSTOM_HAL_SUB_IMGSENSOR = ov8856_mipi_raw s5k3p9sp_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = s5k3p3sx_mipi_raw imx135_mipi_raw imx214_mipi_raw imx363_mipi_raw ov8856_mipi_raw s5k3p9sp_mipi_raw gc0310_mipi_yuv
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9714af dw9800af dw9763af dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dw9763af
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3p3sx_mipi_raw imx135_mipi_raw imx214_mipi_raw imx363_mipi_raw gc0310_mipi_yuv
CUSTOM_KERNEL_MAIN_LENS = dw9714af dw9800af dw9763af
...
CUSTOM_KERNEL_SUB_IMGSENSOR = ov8856_mipi_raw s5k3p9sp_mipi_raw
...
CUSTOM_MODEM = s600_tk_md_basic-lwctg_r2_6763-6m_gsm4p_w1_2_4_5_8_fdd1_2_3_4_5_7_8_12_17_19_20_tdd34_38_39_40_41_tds34_39_c2kbc0_cotsx_airohapa_cat7_tiaoxie
...
CUSTOM_BUILD_VERNO = R13_20180905
MTK_BUILD_VERNO = DOOGEE-S80-Android8.1-20180905
HCT_BUILD_PRODUCT_NAME = s600f-dg-m7-a2-66-1024g48g-fhdp-bom12-o1-cts
...
HCT_PRODUCT_MODEL = S80
HCT_PRODUCT_MANUFACTURER = DOOGEE

HCT_SUPPORT_POWER_SAVE = yes
HCT_SUPPORT_POWER_SAVE_PLUS = yes

#freemecamera
HCT_FREEMECAMERA_SUPPORT = yes
# 录屏
...
HCT_BOOTAUDIO=yes
# 百变解锁
#HCT_RANDOM_CHANGE_LOCKSCREEN=yes
# Hct 桌面/主题
# HCT_LAUNCHER3=yes
HCT_WHITE_LIST=yes
# 护眼模式
...
# 气压计、温度计
HCT_BAROMETER_SUPPORT=yes
#黑屏拍照
# HCT_SUPPORT_FAST_CAMERA_VIDEO=yes
# 手势唤醒
...
# 平行空间
#HCT_LBE_PARALLEL_SPACE=yes
# 默认MTP
HCT_USB_DEFAULT_MTP = yes
HCT_EXTRA_RINGTONE_SHOW_MORE_RINGTONES = yes

#HCT_XINTAI_INPUTMETHOD=yes
#HCT_XINTAI_INPUTMETHOD=default
HCT_S600C_DG_APK=yes
HCT_SUPPORT_FASTCAMERA_QUICKSTART = yes
# 扫码
HCT_QR_CODE_SCAN=yes
# 双卡铃声
LCT_MULTISIM_RINGTONE= 1
HCT_SUPPORT_CONTACT_DIALER_SWITCH = yes
# 单屏壁纸
...
#默认铃声配置
HCT_NOTIFICATION_SOUND=Proxima.ogg
# HCT_ALARM_ALERT=Platinum.ogg
HCT_RINGTONE=Default_Ring.ogg
HCT_MMS_RINGTONE=Pollux.ogg
HCT_ROM_RAM_SIZE_1024G_48G=yes

HCT_SUPPORT_FINGERPRINT = yes
HCT_SUPPORT_FINGERPRINT_CHIP = cdfiner_fps988e_tee fpsensor_icn7222_tee
HCT_SYSTEMUI_THEME_LIGHT=yes
# 功放
# HCT_ARKAMYS_OPTIMSPEAKER=yes
# 数字对讲机
HCT_HCTTALKIE_DIGITAL_SUPPORT = yes
# sos
...
# 游戏模式
# HCT_GAMEMODE_SUPPORT=yes
# 自定义键功能
HCT_SOS_KEY_CUSTOM_SUPPORT = yes
#cts
MTK_2SDCARD_SWAP=no
HCT_GOOGLE_CLIENTIDBASE = android-doogee
# weichen_fota
# fota 符合欧盟标准
ADUPS_FOTA_SUPPORT_GDPR=yes
HCT_GOOGLE_GMS_R7=yes
HCT_PACKAGES_SUBSTITUTE = CarrierServices:- DeskClockGoogle:- FaceLock:- GoogleContacts:- GoogleDialer:- LatinImeGoogle:- \
TagGoogle:- Keep:- CalculatorGoogle:- OobConfig:- GooglePinyinIME:- JapaneseIME:- KoreanIME:- GmsSampleIntegrationL:- \
GmsSampleIntegration:- MtkBrowser:- MtkEmail:- MtkMms:- MtkGallery2:- MusicBspPlus:- MtkLatinIME:- WallpaperPicker:-
MTK_ATF_SUPPORT=yes
MTK_TEE_SUPPORT=yes
